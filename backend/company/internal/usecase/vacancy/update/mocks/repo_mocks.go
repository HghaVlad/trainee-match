...
func (mr *MockVacancyRepoMockRecorder) GetByIDForUpdate(ctx, vacancyID, companyID any) *gomock.Call {
...
func (mr *MockVacancyRepoMockRecorder) Update(ctx, v any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcompRepoMockRecorder) GetByMember(ctx, compID, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
