...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/getcandidates.CandidateResponse"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/getcandidate.CandidateResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/getcandidateresumes.ShortResponse"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/getresume.Response"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/addskill.Request"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "getcandidateresumes.ShortResponse": {
            "type": "object",
            "properties": {
                "candidate_id": {
                    "type": "string"
        ...
        "getresume.Response": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/getresume.ResumeData"
                },
                "id": {
                    "type": "string"
                },
        ...
        "getresume.ResumeData": {
            ...
            "properties": {
                ...
                "date_of_birth": {
                    "description": "Using string to represent date",
                    "type": "string"
                },
                "desired_format": {
                    "type": "string"
                ...
                "education": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/getresume.Education"
                    }
                },
                "email": {
                    "type": "string"
                ...
                "work_experiences": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/getresume.WorkExperience"
                    }
                }
            }
        },
        "getresume.WorkExperience": {
            "type": "object",
            "properties": {
                "company": {
                    "type": "string"
